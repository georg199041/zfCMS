...
class Application_Model_DbTable_Bugs extends Zend_Db_Table_Abstract
{
	...
	//*--without pagination, return 'bugs' object
	public function readBugs($filters = array(), $sortField = null, $limit = null,	$page = 1)
	{
		$select = $this->select();
	...
	//*--with pagination, return 'adapter' object
	public function readPaginatorAdapter($filters = array(), $sortField = null)
	{
		$select = $this->select();
		// add any filters which are set
		if (count($filters) > 0) {
